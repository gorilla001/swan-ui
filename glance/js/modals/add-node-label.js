(function () {
    ...
    angular.module('glance.utils')
        .factory('addNodeLabelModal', addNodeLabelModal);

    /* @ngInject */
    function addNodeLabelModal($mdDialog) {
        
        return {
            open: open,
        };

        function open(templateUrl, ev, father_scope) {
            ...
            var dialog = $mdDialog.show({
                ...
                locals: { father_scope: father_scope },
            });
        ...
        function controller($scope, $mdDialog, gHttp, labelService, $stateParams, 
                            $state, Notification, ClusterStatusMgr, clusterStatus, father_scope) {
