(function () {
    ...
    function Constant($rootScope) {
        ...
        $rootScope.IMAGE_TRIGGER_TYPE = {
            SELECT_TAG: 1,
            SELECT_BRANCH: 2,
            SELECT_ALL: 3
        };
        $rootScope.APP_EVENTS_TYPE = {
        ...
        $rootScope.APP_PROTOCOL_TYPE = [
            {value: 1, name: 'TCP'},
            {value: 2, name: 'HTTP'}
        ];

        $rootScope.SUB_INFOTYPE = {
        ...
        $rootScope.nodeStatusCls[$rootScope.NODE_STATUS.initing] = "fa fa-cog text-normal";
        $rootScope.nodeStatusCls[$rootScope.NODE_STATUS.upgrading] = "fa fa-cog text-normal";
        $rootScope.nodeStatusCls[$rootScope.NODE_STATUS.repairing] = "fa fa-cog text-normal";

        $rootScope.SERVICE_NAME = {
            master: '主控组件',
            marathon: '应用调度组件',
            zookeeper: 'Zookeeper',
            exhibitor: 'ZK监控组件',
        ...
        $rootScope.WARNING_RULE = {
            '>': '大于',
            '==': '等于',
            '<': '小于'
        };
        $rootScope.WARNING_LEVEL = {
            info: '普通',
            warn: '重要',
            crit: '紧急'
        };
