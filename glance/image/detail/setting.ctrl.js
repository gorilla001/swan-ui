(function () {
    ...
    ImageDetailSettingCtrl.$inject = ['project', 'imageservice', 'Notification', 'imageBuildSetting'];

    function ImageDetailSettingCtrl(project, imageservice, Notification, imageBuildSetting) {
        var self = this;
